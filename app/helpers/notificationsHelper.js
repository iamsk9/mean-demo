...
exports.getNotifications = function(params, user) {
	...
	var notificationsQuery = "SELECT n.id, task_id, is_read, description,client_enquiry_id,ce.name,ce.mobile,ce.subject,ce.comment from notifications n INNER JOIN \
